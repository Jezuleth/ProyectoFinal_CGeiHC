...
int main()
{
	...
	*/
	...
	crashPersonaje.init(); // Carga todos los modelos (cuerpo, piernas, pies, etc.)
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (mainWindow.getCamera() == 0)
		{
			...
			camera.setPosition(glm::vec3(0.0f, 80.0f, 0.0f), -90.0f, -90.0f);
		}
		else {
